...
namespace ActivityLog.App {
    ...
    class WorkActivity : Activity {
        ...
        public override string ToString () {
            ...
            result.AppendLine($"WORK ACTIVITY:\nStart Time: {this.startTime},\tEnd Time: {this.endTime},\tHourly Wage: ${this.wage},\tCost of Materials: ${this.materialsCost},\tClient: {this.client},\tDescription: {this.description}");
